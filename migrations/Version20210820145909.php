 ...
 */
final class Version20210820145909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trick (id INT AUTO_INCREMENT NOT NULL, groupe_id INT NOT NULL, author_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, creation_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, INDEX IDX_D8F0A91E7A45358C (groupe_id), INDEX IDX_D8F0A91EF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
